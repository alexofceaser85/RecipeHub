...
namespace ServerTests.Server.Controllers.Ingredients.IngredientsControllerTests
{
    public class GetMissingIngredientsForRecipeTests
    {
        ...
        public void ShouldGetMissingIngredients()
        {
            ...
            recipesService.Setup(mock => mock.GetMissingIngredientsForRecipe(1, sessionKey)).Returns(ingredients);
            var controller = new IngredientsController(recipesService.Object);

            var result = controller.GetMissingIngredientsForRecipe(1, sessionKey);
            ...
            Assert.Multiple(() =>
            {
                ...
                recipesService.Verify(mock => mock.GetMissingIngredientsForRecipe(1, sessionKey), Times.Once());
            });
        }
        ...
        public void ShouldNotGetMissingIngredientsForUnauthorizedException()
        {
            ...
            recipesService.Setup(mock => mock.GetMissingIngredientsForRecipe(1, sessionKey))
                .Throws(new UnauthorizedAccessException(exceptionMessage));
            var service = new IngredientsController(recipesService.Object);

            var result = service.GetMissingIngredientsForRecipe(1, sessionKey);
